...
namespace CodeWarsKatas
{
    ...
    //If the shift is initially 1, the first character of the message to be encoded will be shifted by 1, 
      ...
      public static string Swap(string str)
      {
        ...
        //We want to approximate the sqrt function.Usually this functions takes a floating
        //point number and returns another floating point number,
        ...
        public static object SqrtApproximation(int v)
        {
            var sqrt = (int)Math.Sqrt(v);

            if (sqrt * sqrt < v)
                return new int[] { sqrt, sqrt + 1 };
            else
                return sqrt;             
        }
    }//end class  
